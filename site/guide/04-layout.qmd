...
Un diagrama vale cuando muestra un mecanismo que la prosa explica peor. La cadena normativa es el
caso: tres etapas, dos transformaciones, y una dirección.

Se dibuja con lo mismo que todo lo demás. Cajas de 1px en `border`, texto en mono, flechas de 1px
en `baseline`. Sin iconos, sin relleno de color, sin nodos redondeados.
