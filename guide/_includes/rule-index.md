...
| [`UMB-COL-004`](#umb-col-004) | ■ | El color signal se usa en un solo elemento de la capa de datos por vista | review |
...
| [`UMB-COL-007`](#umb-col-007) | ■ | No se mezclan los dos modos dentro de un mismo panel | review |
...
| [`UMB-CHT-007`](#umb-cht-007) | ▲ | Los ejes van en mono, abreviados, con coma como separador de miles | review |
| [`UMB-CHT-008`](#umb-cht-008) | ■ | El eje y de las barras empieza en cero | review |
...
| ID | | Regla | Comprobación |
|---|---|---|---|
| [`UMB-NUM-001`](#umb-num-001) | ■ | es-MX y en usan coma para miles y punto para decimales | review |
...
| [`UMB-NUM-006`](#umb-num-006) | ■ | Cero, nulo y suprimido se escriben distinto y significan distinto | review |
...
| [`UMB-A11Y-003`](#umb-a11y-003) | ■ | Junto a cada gráfica hay una tabla de datos o un <details> con las cifras | review |
| [`UMB-A11Y-004`](#umb-a11y-004) | ■ | Junto a cada gráfica se puede descargar su CSV | review |
...
| ID | | Regla | Comprobación |
|---|---|---|---|
| [`UMB-MET-001`](#umb-met-001) | ■ | Los verbos causales solo se usan con una estrategia de identificación nombrada | review |
