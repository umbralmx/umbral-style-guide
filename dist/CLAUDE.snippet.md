<!-- Umbral design system v1.4.0 — paste into a downstream repo's CLAUDE.md.
     GENERATED; regenerate from umbralmx/umbral-style-guide rather than editing. -->

## Umbral brand — the minimum

This repo follows the Umbral design system, pinned at **v1.4.0**.
Full guide: https://github.com/umbralmx/umbral-style-guide/tree/v1.4.0/guide
...
```
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.4.0/tokens/build/tokens.css     # web
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.4.0/tokens/build/tokens.json    # anything
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.4.0/tokens/build/tokens.py      # Python / Streamlit / notebooks
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.4.0/tokens/build/tokens.R       # R / Quarto
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.4.0/tokens/build/observable-framework-instrumento.css   # Observable Framework
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.4.0/tokens/build/streamlit-config.toml
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.4.0/rules/rules.json            # the 77 rules, machine-readable
```
