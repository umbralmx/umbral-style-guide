...
This repo follows the Umbral design system, pinned at **v1.3.0**.
Full guide: https://github.com/umbralmx/umbral-style-guide/tree/v1.3.0/guide
...
```
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.3.0/tokens/build/tokens.css     # web
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.3.0/tokens/build/tokens.json    # anything
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.3.0/tokens/build/tokens.py      # Python / Streamlit / notebooks
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.3.0/tokens/build/tokens.R       # R / Quarto
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.3.0/tokens/build/streamlit-config.toml
https://raw.githubusercontent.com/umbralmx/umbral-style-guide/v1.3.0/rules/rules.json            # the 75 rules, machine-readable
```
